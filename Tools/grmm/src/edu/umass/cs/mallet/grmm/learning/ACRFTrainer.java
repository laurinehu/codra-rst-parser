...
//      logger.info ("ACRF trainer iteration " + i + " at time " + (etime - stime)); //joty
...
//    logger.info ("ACRF training time (ms) = " + (etime - stime)); //joty
...
//    timing.tick ("Evaluation time (iteration "+iter+")"); //joty
...
//        if (training != null) { test (acrf, training, "Training"); } //joty
//        if (testing != null) { test (acrf, testing, "Testing"); } //joty
			 ;
      }
      return true;
    }
...
//      BufferedReader reader = new BufferedReader(new InputStreamReader(System.in)); //joty
//		System.out.println ("See :" + returned.size()); //joty
